...
<body>
                                    ...
                                    <div class="faculty-chips">
                                        @forelse($courseAssignments as $a)
                                            <span class="faculty-chip">
                                                {{ $a->faculty->name }}
                                                <form method="POST" action="{{ url('/secretary/program-assignment/' . $a->id) }}" onsubmit="return confirm('Remove this assignment?')" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal-overlay" id="assign-overlay">
        <div class="modal">
            <form method="POST" action="{{ url('/secretary/program-assignment') }}">
                @csrf
