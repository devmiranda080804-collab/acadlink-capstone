...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="page-sub">Buod ng template distribution at accounts.</div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <div class="stat-value">{{ $readyToDistribute }}</div>
                        <div class="stat-label">Ready to Distribute</div>
                    </div>
                </div>
                <div class="stat-card">
                ...
                <div class="panel">
                    ...
                    @forelse($pendingDistribution as $template)
                        <div class="list-item">
                            ...
                            <span class="li-badge">Approved</span>
                        </div>
                    @empty
                        <div class="empty-mini">Walang approved templates na naghihintay ng distribution.</div>
                    @endforelse
                </div>
