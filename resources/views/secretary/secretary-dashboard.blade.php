...
<head>
    ...
    <title>Secretary Dashboard – CBMA System</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .activity-dot { width: 8px; height: 8px; border-radius: 50%; background: #e6a817; flex-shrink: 0; margin-top: 5px; }

        .activity-text { font-size: 12.5px; font-weight: 600; color: #1a1a2e; margin-bottom: 2px; }
        .activity-meta { font-size: 11px; color: #aaa; }

        .activity-empty { text-align: center; padding: 28px 10px; color: #bbb; font-size: 12.5px; }
