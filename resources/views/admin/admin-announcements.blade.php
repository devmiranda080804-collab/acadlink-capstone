...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .ann-actions { display: flex; align-items: center; gap: 8px; flex-shrink: 0; margin-left: 12px; }
        ...
        .modal-field input[type=text], .modal-field textarea { width: 100%; padding: 7px 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 12.5px; color: #333; outline: none; font-family: Arial, sans-serif; transition: border-color 0.15s; }
        ...
        <div class="content">
            ...
            <div class="page-header">
                <div>
                    ...
                    <div class="page-sub">Pumili ng target program(s) para sa iyong announcement</div>
                </div>
