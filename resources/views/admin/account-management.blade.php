...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li class="active"><a href="{{ url('/admin/account-management') }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>Account Management</a></li>
            ...
            <div class="acc-panel">
                ...
                <div class="role-tabs">
                    <a class="role-tab {{ request('role') == null ? 'active' : '' }}"
                       href="{{ url('/admin/account-management') }}">
                        ALL
                    </a>
                    <a class="role-tab {{ request('role') == 'program_head' ? 'active' : '' }}"
                       href="{{ url('/admin/account-management?role=program_head') }}">
                        Program Head
                    </a>
                    <a class="role-tab {{ request('role') == 'secretary' ? 'active' : '' }}"
                       href="{{ url('/admin/account-management?role=secretary') }}">
                        Secretary
                    </a>
                </div>
    ...
    <script>
        ...
        function openEditModal(id, name, email, role, program, year) {
            document.getElementById('modal-overlay').classList.add('open');
        ...
        function openDeleteModal(id, name) {
            ...
            document.getElementById('deleteForm').action = '{{ url('/admin/account-management') }}/' + id;
        ...
        // Auto-open create/edit modal + show error if validation failed
        @if($errors->any())
        ...
        function toggleProgramField(role) {
            ...
            if (role === 'secretary') {
                ...
                yearWrap.style.gridColumn = '1 / -1'; // i-full width yung Academic Year
                select.value = '';
            } else {
