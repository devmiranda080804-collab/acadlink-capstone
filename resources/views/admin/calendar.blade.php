...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cal-day.today:hover { background: #1a3a7a; }
        .cal-day.has-event { background: #dbeafe; color: #1d4ed8; font-weight: 600; }
        .cal-day.has-event:hover { background: #bfdbfe; }
        ...
        /* Add event button */
        .btn-add-event { display: flex; align-items: center; gap: 6px; background: #0f2557; color: #fff; border: none; border-radius: 6px; font-size: 12.5px; font-weight: 600; padding: 9px 16px; cursor: pointer; transition: background 0.15s; margin-bottom: 16px; }
...
<body>
            ...
            <div class="cal-layout">
                ...
                <div class="events-panel">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                        <div class="events-title" style="margin-bottom:0;">Upcoming Activities</div>
                    ...
                    <div id="events-list">
                        {{-- Sample events — papalitan ng dynamic data kapag may backend na --}}
    ...
    <script>
        ...
        // Sample event dates — papalitan ng dynamic data sa backend
        ...
        function openAddModal() {
            // Placeholder — backend na gagawin next
