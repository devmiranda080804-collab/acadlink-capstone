...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="page-sub">I-assign ang faculty ng program mo (<strong>{{ auth()->user()->program }}</strong>) sa mga courses</div>
            ...
            <div class="assign-panel">
                <table class="assign-table">
                    ...
                    <tbody>
                                    ...
                                    <div class="faculty-chips">
                                        @forelse($courseAssignments as $a)
                                            <span class="faculty-chip">
                                                {{ $a->faculty->name }}
                                                <form method="POST" action="{{ url('/program-head/course-assignment/' . $a->id) }}" onsubmit="return confirm('Remove this assignment?')" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        @empty
                            <tr><td colspan="5" class="empty-row">Walang courses na nakita para sa program mo.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    <div class="modal-overlay" id="assign-overlay">
        <div class="modal">
            <form method="POST" action="{{ url('/program-head/course-assignment') }}">
                @csrf
